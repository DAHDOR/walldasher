...
export type UserIdQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id?: string | null } | null };
...
export const UserIdDocument = new TypedDocumentString(`
    query UserID {
  currentUser {
    id
  }
}
    `) as unknown as TypedDocumentString<UserIdQuery, UserIdQueryVariables>;
