    ...
    <div class="flex justify-center items-center absolute w-full h-[144px]">
      ...
      >
        ...
        <g mask="url(#bluegames-mask)">
          <g ref={setBlueGamesRef} id="bluegames">
        ...
        <g mask="url(#orangegames-mask)">
          <g ref={setOrangeGamesRef} id="orangegames">
        ...
        <g mask="url(#blueteam-mask)">
          <g ref={setBlueTeamRef} id="blueteam">
            <g data-name="logo">
        ...
        <g mask="url(#orangeteam-mask)">
          <g ref={setOrangeTeamRef} id="orangeteam">
            <g id="logo">
              <polygon
                class="cls-4"
                points="1192 108 1096 108 1120 36 1216 36 1192 108"
              />
            ...
            <g data-name="details">
              <polygon
                class="cls-2"
                points="1192 108 766 108 767 106 1191 107 1192 108"
              />
