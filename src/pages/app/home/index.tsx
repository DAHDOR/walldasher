    ...
    <div class="px-6 py-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Haga click en el boton de la interfaz que desee para copiar el link de la
            interfaz.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div class="grid grid-cols-2 gap-4">
            ...
            <p class="flex flex-col text-center items-center gap-2">
              ...
              <Button
                class="w-40 bg-white hover:bg-stone-300 text-black"
                onclick={() => copyToClipboard(onIngame())}
              >
                Ingame Overlay
              </Button>
            </p>
            <p class="flex flex-col text-center items-center gap-2">
              ...
              <Button
                class="w-40 bg-white hover:bg-stone-300 text-black"
                onclick={() => copyToClipboard(onRoundrobin())}
              >
                Round Robin Overlay
              </Button>
            </p>
            <p class="flex flex-col text-center items-center gap-2">
              ...
              <Button
                class="w-40 bg-white hover:bg-stone-300 text-black"
                onclick={() => copyToClipboard(onNextup())}
              >
                Next Up Overlay
              </Button>
            </p>
            <p class="flex flex-col text-center items-center gap-2">
              ...
              <Button
                class="w-40 bg-white hover:bg-stone-300 text-black"
                onclick={() => copyToClipboard(onPhase())}
              >
                Phase Overlay
              </Button>
            </p>
